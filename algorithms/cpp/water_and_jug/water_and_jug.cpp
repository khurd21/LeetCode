...
class Solution {
public:
    bool canMeasureWater(const int jug1Capacity, const int jug2Capacity, const int targetCapacity) {
        ...
        if (targetCapacity == 0) {
            ...
            return jug1Capacity == targetCapacity || jug2Capacity == targetCapacity;
        }

        const int g = std::gcd(jug1Capacity, jug2Capacity);
