...
##############################################################################
# Problem: You are given a string text of words that are placed among some
# number of spaces. Each word consists of one or more lowercase English
# letters and are separated by at least one space. It's guaranteed that text
...
class Solution:
    def reorderSpaces(self, text: str) -> str:
        ...
        remainder = numSpaces % (len(words) - 1)
        numSpacesBetweenWords = numSpaces // (len(words) - 1)

        text = (' ' * numSpacesBetweenWords).join(words) + ' ' * remainder
        return text